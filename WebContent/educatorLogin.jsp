...
<body>
	...
	<nav>
		<ul>
			<li><a href="home.jsp">Educator's Home</a></li>
	...
	<div id="titleMargin"><h1>Login Educator </h1></div>
		<div class="formWrapper">
			<form method="post" >
				...
				<div class="formRow">
					<div class="formLeft">
						<button type="button" onclick="goToPage('educatorRegistration.jsp')">New User</button>
					</div>
					<div class="formRight">
						<button type="button" onclick="goToPage('educatorHome.jsp')">Submit</button> <!-- CHANGE THIS -->
					</div>
				</div>
			</form>
