...
<body>
	...
	<nav>
		...
		<div id="contentArea">
	<br>
	<div id="titleMargin"><h1>Please Register</h1></div>
	<div align="center"><h3 >Already Registered?<a href="studentLogin.jsp">  Login</a></h3></div>
	
	<div class="formWrapper">
		<form method="post" name="studenRegistration" action="StudentRegistration" >
		<br><Br>
				...
				<input type="text" name="firstname" placeholder="first name" maxlength="20"/><font color="red" id ="checkusr"></font><br><br><br>
		
				<div class="required"><label>Last Name: </label></div>		
				<input type="text" name="lastname" placeholder="Last name" maxlength="20"/><font color="red" id ="checkusr"></font><br><br><br>
				
				<div class="required"><label>Email: </label></div>		
				<input type="text" name="email" placeholder="Email address" maxlength="20"/><font color="red" id ="checkusr"></font><br><br><br>
				...
				<input type="password" name="passwTwo" onblur="CheckPass(this.form)" onfocus="ResetPassErr()" placeholder="Confirm Password" maxlength="20"/><font color="red" id ="checkpw"></font><br><br>
				<br><br><br>
...
<br><br>
			...
			<input type="button" value="Create My Account" onclick="goToPage('studentHome.jsp')"><br><br><!-- "CheckFields()" -->
